...
export default function Login() {
  ...
  const handleLogin = async () => {
    router.push('/');
    if (name === 'admin') {
      router.push('/'); // Redireciona para a tela de administrador
    }
    try {
      ...
      if (name === 'admin') {
        ...
        router.push('/'); // Redireciona para a tela do usuário comum
      }
    } catch (error) {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.registerContainer}>
        <Text style={styles.registerText}>Já tens conta?</Text>
